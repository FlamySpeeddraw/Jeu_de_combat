...
function gagnant({ player, enemy, timerId }) {
    clearTimeout(timerId);
    document.querySelector('#displayText').style.display = 'flex';
    if (player.health === enemy.health) {
        document.querySelector('#displayText').innerHTML = 'égalité';
    } else if (player.health > enemy.health) {
        document.querySelector('#displayText').innerHTML = 'Le joueur 1 gagne';
    } else if (player.health < enemy.health) {
        document.querySelector('#displayText').innerHTML = 'Le joueur 2 gagne';
    }
}
